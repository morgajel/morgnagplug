...
# Response Time
#
$opt[1] = "--vertical-label \"Seconds\" --title \"Response Times $hostname / $servicedesc\" -u 1";
#
#
#
...
# Filesize
#
$opt[2] = "--vertical-label \"Bytes\" --title \"Size $hostname / $servicedesc\" ";
#
#
#
...
$def[2] .= rrd::gradient("var1", "003311", "66CCAA", "$NAME[2]"); 
